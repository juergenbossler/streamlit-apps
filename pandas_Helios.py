...
def read_in_data():
    helios_raw = pd.read_excel("HELIOS_Rohdaten.xls", sheet_name="Tabelle1", dtype= {'Ralu': str, 'Materialnummer IR': str, 'Materialnummer OR': str, 'Bezeichnung IR': str, 'Bezeichnung OR': str})
